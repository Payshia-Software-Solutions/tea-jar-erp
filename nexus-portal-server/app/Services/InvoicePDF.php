...
class InvoicePDF {
    public static function generate($data, $isReceipt = false) {
            ...
            try {
                if (strpos($logoPath, 'http') !== 0) {
                    ...
                    if (!$imgData) {
                        ...
                        $fallbackUrl = 'https://portal.nebulync.com/nebulync-logo-new.png';
        ...
        <body>
                ...
                <tr>
                    <td width='50%'>
                        <div style='font-size: 11px; color: #94a3b8; line-height: 1.6;'>
                            ...
                            For billing inquiries, contact billing@nebulync.com.
                        </div>
                    </td>
            ...
            <div class='footer'>
                <strong>" . ($company['company_name'] ?? 'Nebulync Systems (Pvt) Ltd') . "</strong><br>
