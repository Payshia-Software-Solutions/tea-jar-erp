...
export default function ReportsPage() {
  ...
  const groups = useMemo(() => {
    const inventory: ReportLink[] = [
      ...
      { title: "Material Issues Summary", desc: "Summary of stock items issued via issue notes within a date range", href: "/reports/material-issues-summary", icon: FileText },
